 ...
 */
final class ArrayStructureValidateExactHandler extends AbstractHandler implements HandlerInterface
{
    use TagIndexMethod;
    ...
    public function __invoke(mixed $value): Result
    {
        ...
        $structureValidator = new ArrayStructureExactValidation(
            new ErrorCollector(),
            $this->ignoreNulls,
            $this->checkTypes
        );
        ...
        $message = \sprintf(
            '%s [ArrayStructureValidateExactHandler] Errors: %s.',
            addIdInMessage(),
